...
while True:
	...
	if choice=="hello":
		print(" hola ")
		print("it is used to great someone")
	elif choice=="goodbye":
		print(" adiós ")
		print("used to end a conversation")
	elif choice=="see you later":
		print("hast luego")
		print("used to end a conversation")
	elif choice=="see you":
		print("hasta la vista")
		print("used to end a conversation")
	elif choice=="good day":
			print("buenos dias")
			print("a greeting")
	elif choice=="good afternoon":
		print("buenas tardes")
		print("a greeting")
		...
		print("¿Qué tal?")
		print("to ask aperson how the are feeling")
	elif choice=="ok":
		print("bien")
		print("a feeling")
	elif choice=="so so":
		...
		print("mal")
		print("a feeling")
	elif choice=="wonderful":
		print("estupundo")
		print("a feeling or how your day is")
	elif choice=="fantastic":
		print("fantástico")
		print("a feeling or how your day is")
	elif choice=="terrible":
		print("fatal")
		print("a feeling or how your day is")
	elif choice=="thank you":
		print("graclas")
		print("to thank someone for something")
	elif choice=="what is your name":
		print("¿cómo te llamas?")
		print("a greeting for someone you dont know the name of")
	elif choice=="personal pronouns":
		print("yo")
		print("tú")
		print("él/ella")
		print("nosotros/as")
		print("vosotros/as")
		print("ellos/ellas")
		print("used to write about someone")
	elif choice=="to be":
		print("estar")
		print("estoy")
		print("estás")
		...
		print("una vaca")
		print("a animal")
	elif choice=="there is":
		print("hay")
	elif choice=="there are":
		print("hay")
	elif choice=="cold":
		print("frío")
		...
		print("to live") 
	elif choice=="to describe":
		print("describir")
	elif choice=="to write":
		print("escribir")
	elif choice=="to receive":
		print("recibir")
	elif choice=="to go out":
		print("sailr")
	elif choice=="in a house":
		print("en una casa")
	elif choice=="in an apartment":
		print("en un apartamento")
	elif choice=="in a flat":
		print("en un piso ")
	elif choice=="in the city":
		print("en la ciudad")
	elif choice=="street":
		print("la calle")
	elif choice=="the avenue":
		print(" la avenida")
	elif choice=="in the city centre":
		print("en el centro de la ciudad")
	elif choice=="in the suburbs":
		print(" en las afueras")
		print("outskirts of the city")
	elif choice=="in the area of...":
		print("en el barrio de...")
	elif choice=="in the country":
		print("en el campo")
	elif choice=="in a town":
		print("en un pueblo")
	elif choice=="in a village":
		print("en una aldea")
	elif choice=="in county":
		print("en el condado de...")
	elif choice=="near the sea":
		print("cerca del mar")
	elif choice=="upstairs":
		print("arriba")
	elif choice=="downstairs":
		print("abajo")
	elif choice=="the ground floor":
		print("la planta baja")
	elif choice=="the first floor":
		print("la primera planta")
	elif choice=="the second floor":
		print("la segunda planta")
	elif choice=="the third floor":
		print("la tarcera planta")
	elif choice=="the kitchen":
		print("la cocina")
	elif choice=="the sitting room":
		print("el salón")
		print("where the family come together")
	elif choice=="the living room":
		print("la sala de estar")
		print("where guests are brought")
	elif choice=="the dining room":
		print("el comedor")
		print("where you sit and eat")
	elif choice=="the utility room":
		print("el lavadero")
	elif choice=="the corridor":
		print("el pasillo")
	elif choice=="the office":
		print("la oficina")
	elif choice=="the study":
		print("el despacho")
	elif choice=="the front door":
		print("la puerta principal")
	elif choice=="the bedroom":
		print("el dormitorio")
	elif choice=="the bathroom":
		print("el cuarto de baño")
	elif choice=="the guest room":
		print("el cuarto de huéspedes")
	elif choice=="the attic":
		print("el desván")
	elif choice=="the balcony":
		print("la terraza")
	elif choice=="the garden":
		print("el jardín")
	elif choice=="the flower":
		print("la flor")
	elif choice=="the tree":
		print("el árbol") 
	elif choice=="the furniture":
		print("los muebles")
	elif choice=="the chair":
		print("la silla")
	elif choice=="the table":
		print("la mesa")
	elif choice=="the armchair":
		print("la butaca")
		print("only for one person")
	elif choice=="the sofa":
		print("el sofá")
	elif choice=="the tap":
		print("el grifo")
	elif choice=="the cooker":
		print("la cocina eléctrica")
	elif choice=="the lamp":
		print("la lámpara")
	elif choice=="the fridge":
		print("la nevera")
		print("el frigo")
	elif choice=="the television":
		print("el televisor")
	elif choice=="the small table":
		print("la mesilla")
	elif choice=="the pictures":
		print("los cuadros")
	elif choice=="the ceiling":
		print("el tacho")
	elif choice=="the roof":
		print("el tejado")
	elif choice=="the stairs":
		print("la escalera")
	elif choice=="the lift":
		print("el ascensor")
	elif choice=="the bed":
		print("la cama")
	elif choice=="the dvd":
		print("un dvd")
	elif choice=="the toilet":
		print("el lavabo")
	elif choice=="the wardrobe":
		print("el armario")
	elif choice=="the sideboard":
		print("el tocador")
	elif choice=="the set of shelves":
		print("una estantería")
	elif choice=="the shelf":
		print("el estante")
	elif choice=="the bedside table":
		print("la mesa de noche")
	elif choice=="the bath":
		print("el baño")
	elif choice=="the shower":
		print("la ducha")
	elif choice=="the curtains":
		print("las cortinas")
	elif choice=="the wall":
		print("la pared")
	elif choice=="the balcony":
		print("el balcón")
	elif choice=="the basement":
		print("el sótano")
	elif choice=="the floor":
		print("el suelo")
	elif choice=="bedside":
		print("al lado de")
	elif choice=="at the end of":
		print("al final de")
	elif choice=="near":
		print("cerca de")
	elif choice=="in front of":
		print("delante de")
	elif choice=="behind":
		print("detrás")
	elif choice=="opposite":
		print("enfrente de")
	elif choice=="far from":
		print("lejos de")
	elif choice=="for sale":
		print("se vende")
	elif choice=="to rent":
		print("se alquila")
	elif choice=="show house":
		print("casa piloto")
		print("used to show what the other if any houses will look like")
	elif choice=="show flat":
		print("piso piloto")
		print("used to show what the other if any flats will look like")
	elif choice=="1:00":
		print("es la una")
	elif choice=="2:00":
		print("son las dos")
		...
		print("at")
		print("exact time")
	elif choice=="at midday":
		print("a mediodía")
		print("12:00 a.m")
	elif choice=="at midnight":
		print("a medianoche")
		print("12:00 p.m")
	elif choice=="a.m":
		print("de la mañana")
		...
		print("de la tarde")
	elif choice=="at about":
		print("a eso de")
		print("around the time you choose")
	elif choice=="exactly":
		print("en punto")
	elif choice=="to get up":
		print("lavantarse")
	elif choice=="to have a shower":
		print("ducharse")
	elif choice=="to shave":
		print("afeitarse")
	elif choice=="to relax":
		print("relajarse")
	elif choice=="to put on":
		print("ponerse")
		print("to place")
	elif choice=="to become":
		print("ponerse")
	else:
		print("not a word in this code, try again")
